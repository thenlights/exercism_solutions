...
def preparation_time_in_minutes(number_of_layers):
    ...
    Function that the expected preparation time considering a time of
        `PREPARATION_TIME` minutes per layer.
    """
...
def elapsed_time_in_minutes(number_of_layers, elapsed_bake_time):
    ...
    :param elapsed_bake_time: int - the number of minutes the lasagna has 
